...
$introType = get_field('intro_type', $page_id);
$rando = get_field('randomizer', $page_id);
...
<?php if($rando) { ?>
    <script>
        jQuery(document).ready(function () {
            var images = [
                <?php foreach($rando as $rand) {
                        echo "'" .  $rand['image']['sizes']['crb_fullwidth_image'] . "',";
                } ?>
            ];
            jQuery('#background').css({'background-image': 'url(' + images[Math.floor(Math.random() * images.length)] + ')'});
        });
    </script>
<?php } ?>
...
<?php if($video_intro) { ?>
    ...
    <div class="intro-video <?php echo $introType; ?>">
...
<div class="intro <?php echo $additional_intro_classes; ?> <?php echo $introType; ?>">
    <figure id="background" class="intro__image fullsize-image"></figure><!-- /.intro__image -->
